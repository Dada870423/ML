...
if CD_mode != "Discrete":
    ...
    MNIST_CC.TRAIN(train_label_file = "train-labels-idx1-ubyte", train_image_file = "train-images-idx3-ubyte")
    ...
    print("Discrete gogo!!")
    MNIST_DS.TRAIN(train_label_file = "train-labels-idx1-ubyte", train_image_file = "train-images-idx3-ubyte")
